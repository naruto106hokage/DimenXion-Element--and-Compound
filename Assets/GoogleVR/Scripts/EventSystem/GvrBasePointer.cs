...
#if !UNITY_EDITOR
            return isTriggerDown || GvrControllerInput.ClickButtonDown || CardboardControllerInput.OkButtonDown || Input.GetButtonDown("Fire1") || (Input.anyKeyDown && Input.inputString.Equals(System.Environment.NewLine));
#else
...
#if !UNITY_EDITOR
            return isTriggering || GvrControllerInput.ClickButton || CardboardControllerInput.OkButtonPressed || Input.GetButton("Fire1") || Input.anyKey;
#else
...
#if !UNITY_EDITOR
            return isTriggerDown || GvrControllerInput.ClickButtonUp || CardboardControllerInput.OkButtonUp || Input.GetButtonUp("Fire1");
#else
