...
namespace InfinityEditor
{
    ...
    public class SplitPane : ScriptableObject
    {
        ...
        /// </summary>
        public SplitPaneOrientations Orientation { get; private set; }
        ...
        public static SplitPane Create(SplitPaneOrientations orientation, float dividendSize)
        {
            SplitPane split = ScriptableObject.CreateInstance<SplitPane>();
        ...
        public void Draw()
        {
            style = Orientation == SplitPaneOrientations.Vertical ?  GUI.skin.verticalSlider : GUI.skin.horizontalSlider;
        ...
        {
            if (Orientation == SplitPaneOrientations.Vertical)
            {
        ...
        private void DrawRight()
        {
            ...
            if (onDrawRightComponent != null)
            {
                onDrawRightComponent();
            }
            GUILayout.EndArea();
        }
