...
namespace InfinityEditor
{
    ...
    public static class Utils
    {
        ...
        private static int go_count = 0, components_count = 0, error_count = 0;
        ...
        public static bool DradAndDropArea(float width, float height, string message, Color onDragColor)
        {
        ...
        /// <param name="message">The message to display in the drag and drop area</param>
        /// <returns><c>true</c> if there is an dragged object <c>false</c> otherwise.</returns>
        public static bool DradAndDropArea(float width, float height, string message)
        {
            return DradAndDropArea(width, height, message, Color.green);
        }
        ...
        /// <summary>
        /// Parse the given xml text
        /// </summary>
        /// <param name="xml">The xml text</param>
        /// <param name="action">The action do for each xmlnode</param>
        public static void ParseXmlResource(string xml, Action<XmlNode> action)
        {
