...
namespace InfinityEngine.Localization {
    ...
    /**************************************************************************
    * LINK TO DOWNLOAD FOR FREE THE JAVA PROJECT 
    *
    * 	https://www.dropbox.com/s/gmws6hp7domtuz6/SpeechEngine.zip?dl=0
    *	
    ***************************************************************************/
    ...
    public class SpeechEngine : Singleton<SpeechEngine>
    {
        ...
        {
            get { return PlayerPrefs.GetInt("ENABLED_SPEECH_ENGINE", 1) == 1 && Instance.engine != null; }
        ...
        /// </summary>
        public static Locale CurrentLocale { get { return Instance.mCurrentLocale; } }

        /// <summary>
        /// The current voice of the plugin.
        /// </summary>
        public static Voice CurrentVoice { get { return Instance.mCurrentVoice; } }
        ...
        public static Voice[] AvaillableVoices
        {
            get
            {
                ...
                return Instance.engine.Call<AndroidJavaObject[]>("getAvailableVoices").Select(elem => new Voice(elem));
            }
        }
        ...
        public static TTSEngine[] AvailableEngines
        {
            get
            {
                ...
                return Instance.engine.Call<AndroidJavaObject[]>("getAvailableEngines").Select(elem => new TTSEngine(elem));
            }
        }
        ...
        /// </summary>
        /// <param name="locale">new voice</param>
        ...
        /// </summary>
        /// <param name="locale">new engine</param>
        ...
        /// </summary>
        /// <param name="language">The Locale object which will contains the language and the country</param>
