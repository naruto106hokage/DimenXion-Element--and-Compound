...
namespace InfinityEngine.Localization
{
    ...
    /// <summary>
    /// Represents java.util.Locale object
    /// </summary>
    [Serializable]
    public class Locale
    {
        ...
        public string Informations
        {
            get
            {
                return Name + " : " + LanguageCode + " : " + Country;
            }
        }
        ...
        public AndroidJavaObject ToJavaLocaleObject()
        {
            return SpeechEngine.CreateLocale(this);
        }
        ...
        {
            return AllLocales.First(elem => elem.Name == name);
        }
