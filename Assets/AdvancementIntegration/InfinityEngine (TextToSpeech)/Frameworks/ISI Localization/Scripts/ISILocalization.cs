...
namespace InfinityEngine.Localization
{
    ...
    public class ISILocalization : Singleton<ISILocalization>
    {
        ...
        [SerializeField]
        private int m_loadSceneDelay = 3;

        [SerializeField]
        private List<LocalizedLanguage> m_languages;


        [SerializeField]
        private List<string> m_stringKeys;

        [SerializeField]
        private List<string> m_audiosKeys;

        [SerializeField]
        private List<string> m_spriteKeys;

        [SerializeField]
        [MinMaxRange(1, "GetStringMaxRange")]
        private MinMax m_stringKeysRange;
        [MinMaxRange(1, "GetAudioMaxRange")]
        [SerializeField]
        private MinMax m_spriteKeysRange;
        [MinMaxRange(1, "GetSpriteMaxRange")]
        [SerializeField]
        private MinMax m_audioKeysRange;
        ...
        private Language DefaultLanguage
        {
            get
            {
                string pref = PlayerPrefs.GetString(DefaultLanguagePreferenceKey, Language.English.ToString());
        ...
        public List<LocalizedLanguage> LocalizedLanguages
        {
            ...
            {
                if (m_languages == null)
                    m_languages = new List<LocalizedLanguage>();
        ...
        public List<string> AudioKeys
        {
            get
            {
                if (m_audiosKeys == null)
                    m_audiosKeys = new List<string>();
        ...
        public List<string> SpriteKeys
        {
            get
            {
                if (m_spriteKeys == null)
                    m_spriteKeys = new List<string>();
        ...
        /// </summary>
        public int LanguageCount { get { return LocalizedLanguages.Count; } }
        ...
        /// </summary>
        public static bool IsInitialized { get { return Instance.m_isInitialized; } }
        ...
        {
            return LocalizedLanguages.TrueForAny(token => token.Language == language);
        }
        ...
        public void Validate()
        {
            ...
            {
                l.LocalizedAudio   = l.LocalizedAudio.Where(elem => m_audiosKeys.Contains(elem.Key));
                l.LocalizedStrings = l.LocalizedStrings.Where(elem => m_stringKeys.Contains(elem.Key));
                l.LocalizedSprites = l.LocalizedSprites.Where(elem => m_spriteKeys.Contains(elem.Key));
            }
        }
        ...
        /// <summary>
        ///  Gets the value the given <paramref name="key"/> in current <see cref="CurrentLanguage"/>
        /// </summary>
        /// <remarks>
        ...
        ///     The can use the returned value as a string object.
        ///     
        /// </remarks>
        /// 
        /// <example>
        ...
        {
            if (!string.IsNullOrEmpty(Instance.m_nextScene))
            {
                Infinity.LoadLevelAfterDelay(Instance.m_nextScene, Instance.m_loadSceneDelay);
            }
            else
            {
