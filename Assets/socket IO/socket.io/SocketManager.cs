...
namespace socket.io
{
	...
	public class SocketManager : MonoSingleton<SocketManager>
	{
		...
		/// </summary>
		public List<UniRx.Tuple<Socket, bool, int, DateTime>> _connectRequests = new List<UniRx.Tuple<Socket, bool, int, DateTime>> ();
		...
		void Update ()
		{
			...
			//Debug.Log ("Request Length: " + _connectRequests.Count);
